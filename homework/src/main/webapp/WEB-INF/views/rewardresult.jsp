								...
								<div class="row clearfix">
									...
									<div class="row clearfix">
										<div class="col-md-12 column">
											<ul class="pagination">
												<li><a
													href="<c:url value="/rewardrecord?itcode=${itcode}&minvol=${minvol}&maxvol=${maxvol}&beghour=${beghour}&begmin=${begmin}&endhour=${endhour}&endmin=${endmin}&page=1"/>">首页</a></li>
												<li><a
												...
												<div class="modal-content">
													...
													<div class="modal-body" style="text-align: center;">
														<form role="form" name="form2" id="form2"
															...
															<div class="form-group">
																<label for="minvol">打赏金额</label> <select id="minvol"
															...
															<div class="form-group">
																<label for="beghour">打赏时间</label><select id="beghour"
