...
public class ProgramDAO {
	...
	public static List<Program> getProgramByPage(int begindex, int endindex, JdbcTemplate jdbcTemplate) {
		try {
			...
			List<Program> program = jdbcTemplate.query("select * from program order by start_time limit ?, ?",
					program_mapper, new Object[] { begindex, endindex });
			return program;
		} catch (Exception e) {
			return null;
		}
	...
	public static Program getProgramByName(String pro_name, JdbcTemplate jdbcTemplate) {
		try {
			RowMapper<Program> program_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			Program program = jdbcTemplate.queryForObject("select * from program where pro_name=?", program_mapper,
					pro_name);
			return program;
		} catch (Exception e) {
			return null;
	...
	public static Program getProgramByPerfomer(String performer, JdbcTemplate jdbcTemplate) {
		try {
			RowMapper<Program> program_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			Program program = jdbcTemplate.queryForObject("select * from program where performer=? order by start_time",
					program_mapper, performer);
			return program;
		} catch (Exception e) {
			return null;
		}
	...
	public static Program getProgramByTime(String start_time, JdbcTemplate jdbcTemplate) {
		try {
			RowMapper<Program> program_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			Program program = jdbcTemplate.queryForObject(
					"select * from program where start_time=? order by start_time", program_mapper, start_time);
			return program;
		} catch (Exception e) {
			return null;
		}
	...
	public static List<Program> getProgramByWid(int dept_id, JdbcTemplate jdbcTemplate) {
		try {
			RowMapper<Program> program_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			List<Program> program = jdbcTemplate.query("select * from program where dept_id=? order by start_time",
					program_mapper, dept_id);
			return program;
		} catch (Exception e) {
			return null;
		}
	 ...
	 * @return
	 */
	public static boolean Createprogram(String name, String performer, String time, int dept,
	...
	public static List<Program> getAll(JdbcTemplate jdbcTemplate) {
		try {
			...
			List<Program> program = jdbcTemplate.query("select * from program order by start_time", pro_mapper);
			return program;
		} catch (Exception e) {
			return null;
		}
	 ...
	 * @return
	 */
	public static List<Program> getAllPrograms(int program_id, String program_name, int department,
			JdbcTemplate jdbcTemplate) {
		try {
			...
			List<Program> programs = jdbcTemplate.query(
					"select * from program where pid=? and pro_name=? and dept_id=? order by start_time",
	...
	public static List<Program> getWithoutDepartment(int program_id, String program_name, JdbcTemplate jdbcTemplate) {
		try {
			...
			RowMapper<Program> programs_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			List<Program> programs = jdbcTemplate.query(
					"select * from program where pid=? and pro_name=? order by start_time", programs_mapper,
					new Object[] { program_id, program_name });
			return programs;
		} catch (Exception e) {
			return null;
		}
	...
	public static List<Program> getWithoutName(int program_id, int department, JdbcTemplate jdbcTemplate) {
		try {
			...
			RowMapper<Program> programs_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			List<Program> programs = jdbcTemplate.query(
					"select * from program where pid=? and dept_id=? order by start_time", programs_mapper,
					new Object[] { program_id, department });
			return programs;
		} catch (Exception e) {
			return null;
		}
	...
	public static List<Program> getWithoutId(String program_name, int department, JdbcTemplate jdbcTemplate) {
		try {
			...
			RowMapper<Program> programs_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			List<Program> programs = jdbcTemplate.query(
					"select * from program where pro_name=? and dept_id=? order by start_time", programs_mapper,
					new Object[] { program_name, department });
			return programs;
		} catch (Exception e) {
			return null;
		}
	...
	public static List<Program> getByPidOnly(int program_id, JdbcTemplate jdbcTemplate) {
		try {
			Program pro = ProgramDAO.getProgramByPid(program_id, jdbcTemplate);
			RowMapper<Program> programs_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			List<Program> programs = jdbcTemplate.query("select * from program where pid=? order by start_time",
	...
	public static List<Program> getByNameOnly(String program_name, JdbcTemplate jdbcTemplate) {
		try {
			Program pro = ProgramDAO.getProgramByName(program_name, jdbcTemplate);
			RowMapper<Program> programs_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			List<Program> programs = jdbcTemplate.query("select * from program where pro_name=? order by start_time",
	...
	public static List<Program> getByDepartmentOnly(int department, JdbcTemplate jdbcTemplate) {
		try {
			...
			RowMapper<Program> programs_mapper = new BeanPropertyRowMapper<Program>(Program.class);
			List<Program> programs = jdbcTemplate.query("select * from program where dept_id=? order by start_time",
	...
	public static boolean programUpdate(int program_id, String name, String performer, String time, int dept,
			JdbcTemplate jdbcTemplate) {
		try {
			int i = jdbcTemplate.update("update program set pro_name=?,performer=?,start_time=?,dept_id=? where pid=?",
					new Object[] { name, performer, time, dept, program_id });
			if (i > 0) {
